# RotterMaatje User Guide 📖 | Gebruikershandleiding

---

## 🇬🇧 English

Welcome to **RotterMaatje**, your AI assistant for homeless aid in Rotterdam.

### Getting Started
Type your question in any supported language: Dutch, English, Polish, or Arabic.

### Features

**🔄 Translation Buttons** - After each response, click to translate:
- 🇵🇱 Polski | 🇸🇦 العربية | 🇬🇧 English

**👤 Context Mode** - Use the ⚙️ settings menu:
- **Volunteer Mode**: Guidance for volunteers helping homeless individuals
- **Direct Mode**: Speaks directly to the person in need

**🔒 Privacy** - This chatbot **never** asks for or stores sensitive personal data (such as BSN, full names, or ID numbers). Do not share your personal identification here.

**⚠️ Safety Features** - Automatic detection of emergencies and sensitive topics
...
### Aan de slag
Typ je vraag in een ondersteunde taal: Nederlands, Engels, Pools of Arabisch.

### Functies

**🔄 Vertaalknoppen** - Na elk antwoord, klik om te vertalen:
- 🇵🇱 Polski | 🇸🇦 العربية | 🇬🇧 English

**👤 Context Modus** - Gebruik het ⚙️ instellingenmenu:
- **Vrijwilliger Modus**: Begeleiding voor vrijwilligers die daklozen helpen
- **Direct Modus**: Spreekt rechtstreeks tot de persoon in nood

**🔒 Privacy** - Deze chatbot vraagt **nooit** naar gevoelige persoonsgegevens (zoals BSN, volledige namen of ID-nummers) en slaat deze niet op. Deel hier geen persoonlijke identificatiegegevens.

**⚠️ Veiligheidsfuncties** - Automatische detectie van noodgevallen en gevoelige onderwerpen
...
> ⚠️ **Disclaimer**: This chatbot provides information only. For emergencies, call **112**.
> 
> **Disclaimer**: Deze chatbot geeft alleen informatie. Bel bij noodgevallen **112**.
